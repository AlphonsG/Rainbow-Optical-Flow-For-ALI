...
[![Coverage Status](https://coveralls.io/repos/github/AlphonsG/Automated-Air-Liquid-Interface-Cell-Culture-Analysis-Using-Deep-Optical-Flow/badge.svg?branch=dev2)](https://coveralls.io/github/AlphonsG/Automated-Air-Liquid-Interface-Cell-Culture-Analysis-Using-Deep-Optical-Flow?branch=dev2)
...
Rainbow can be installed on Linux, Windows and macOS. Although it is not a requirement, we recommend installing and running Rainbow on a GPU-enabled system to minimize processing times.

## Installation

We recommend installing and running Rainbow within a virtual environment. Rainbow supports Python 3.6 and up.
...
The data generated in the input image sequence directory should be similar to [this](examples/example_output).
